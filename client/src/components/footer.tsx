  ...
  return (
    <footer className="bg-dark-brown text-cream-bg py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center">
                ...
                <span className="text-cream-bg">Mulago, Kampala Uganda</span>
              </div>
              <div className="flex items-center">
                <Phone className="text-sweet-pink mr-3 h-5 w-5" />
                <span className="text-cream-bg">0770 952 685</span>
              </div>
              <div className="flex items-center">
                <Phone className="text-sweet-pink mr-3 h-5 w-5" />
                <span className="text-cream-bg">0755 038 382</span>
              </div>
              <div className="flex items-center">
                <User className="text-sweet-pink mr-3 h-5 w-5" />
                <span className="text-cream-bg">Manager Sharon</span>
              </div>
            </div>
          </div>
        </div>
        ...
        {/* Copyright */}
        <div className="border-t border-chocolate-brown mt-8 pt-8 text-center">
          <p className="text-cream-bg">
